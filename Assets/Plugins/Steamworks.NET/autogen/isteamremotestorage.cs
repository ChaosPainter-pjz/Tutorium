...
namespace Plugins.Steamworks.NET.autogen
{
    public static class SteamRemoteStorage
    {
        ...
        public static SteamAPICall_t PublishWorkshopFile(string pchFile, string pchPreviewFile, AppId_t nConsumerAppId,
            ...
            System.Collections.Generic.IList<string> pTags, EWorkshopFileType eWorkshopFileType)
        {
            InteropHelp.TestIfAvailableClient();
            using (var pchFile2 = new InteropHelp.UTF8StringHandle(pchFile))
        ...
        public static bool UpdatePublishedFileTags(PublishedFileUpdateHandle_t updateHandle,
        ...
        public static SteamAPICall_t PublishVideo(EWorkshopVideoProvider eVideoProvider, string pchVideoAccount,
            ...
            string pchDescription, ERemoteStoragePublishedFileVisibility eVisibility,
            System.Collections.Generic.IList<string> pTags)
        {
            InteropHelp.TestIfAvailableClient();
        ...
        public static SteamAPICall_t EnumeratePublishedWorkshopFiles(EWorkshopEnumerationType eEnumerationType,
            uint unStartIndex, uint unCount, uint unDays, System.Collections.Generic.IList<string> pTags,
