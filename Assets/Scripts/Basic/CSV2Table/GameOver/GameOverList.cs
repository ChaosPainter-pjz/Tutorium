...
namespace Basic.CSV2Table.GameOver
{
    public class GameOverList
    {
        ...
        public GameOverList(TextAsset csv)
        {
            Load(csv);
        }
        ...
        public void Load(TextAsset csv)
        {
            ...
            for (var i = 1; i < grid.Length; i++)
            {
                ...
                row.EndID = grid[i][0];
                row.Level = grid[i][1];
                row.StudentID = grid[i][2];
                row.EndName = grid[i][3];
                ...
                row.绘画 = grid[i][31];
                row.运动 = grid[i][32];
                row.FriendID = grid[i][33];
                row.FriendshipValue = grid[i][34];
        ...
        public Row Find_EndID(string find)
        {
            return rowList.Find(x => x.EndID == find);
        }

        public List<Row> FindAll_EndID(string find)
        {
            return rowList.FindAll(x => x.EndID == find);
        }
        ...
        public Row Find_EndName(string find)
        {
            return rowList.Find(x => x.EndName == find);
        }

        public List<Row> FindAll_EndName(string find)
        {
            return rowList.FindAll(x => x.EndName == find);
        }
        ...
        public Row Find_GESymbol(string find)
        {
            return rowList.Find(x => x.GESymbol == find);
        }

        public List<Row> FindAll_GESymbol(string find)
        {
            return rowList.FindAll(x => x.GESymbol == find);
        }
