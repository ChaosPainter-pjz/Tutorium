...
namespace StartScene
{
    public class ArchiveControl : MonoBehaviour
    {
        ...
        {
            saveData = SaveManager.Scripts.SaveManager.LoadGame(id);
        ...
        {
            SaveManager.Scripts.SaveManager.SaveGame(saveObject.SaveData,id);
        ...
        private void NewGame()
        {
            ...
            SaveManager.Scripts.SaveManager.SaveGame(saveData,id);
            LoadGame();
        }
        // 加载存档以开始游戏
        ...
        {
            SaveManager.Scripts.SaveManager.ResetSaveFile(id);
            UIUpdate();
        }
    }
}
