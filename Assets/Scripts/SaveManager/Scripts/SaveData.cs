...
[Serializable]
    public class SaveData
    {
        ...
        /// </summary>
        [SerializeField]
        public Date gameDate=new Date(2000, 0, 1,0);
        /// <summary>
        /// 世界的解锁状态
        /// </summary>
        ...
        /// </summary>
        [SerializeField]
        public Date parkDate=new Date(2000, 0, 1,0);
        /// <summary>
        /// 超市上次进货时间
        /// </summary>
        [SerializeField]
        public Date supermarketDate = new Date(2000, 0, 1,0);
        /// <summary>
        /// 超市商品
        /// </summary>
        ...
        /// </summary>
        [SerializeField]
        public Date midtermDate = new Date(2000, 0, 1,0);
        /// <summary>
        /// 期中考试提升倍率
        /// </summary>
        [SerializeField]
        public float midtermEfficiency = 0.07f;
        /// <summary>
        /// 分班中
        /// </summary>
        ...
        [SerializeField]
        public List<StudentUnit> studentUnits=new List<StudentUnit>();
        /// <summary>
        /// 教室的日程
        /// </summary>
        [SerializeField]
        public Schedule[] classroomSchedule=
        {
        ...
        /// </summary>
        [SerializeField]
        public float classroomEfficiency = 1.5f;
        /// <summary>
        /// 剧情所用的存档id
        /// </summary>
