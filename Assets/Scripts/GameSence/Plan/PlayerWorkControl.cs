...
public class PlayerWorkControl : MonoBehaviour
{
    ...
    private void UIUpdate()
    {
        ...
        workYield.text ="￥" + (playerCourse.level *  int.Parse(workRow.levelYield) + int.Parse(workRow.InitialYield));
    ...
    {
        int maxEx = playerCourse.level>=int.Parse(workRow.maxLevel) ? 0 : int.Parse(workRow.UpExperience);
