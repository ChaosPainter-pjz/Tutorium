...
public class Date
{
    ...
    {
        return b is { } && a is { } && a.year == b.year && a.Semester == b.Semester && a.Week == b.Week && a.WhatDay == b.WhatDay;
    }
    public static bool operator!=(Date a, Date b)
    {
    ...
    {
        string strSemester = semester switch
        {
            0 => "上", 1 => "下",
    ...
    {
        Long,Brief,Week,Year,YearAndSemester
    }
